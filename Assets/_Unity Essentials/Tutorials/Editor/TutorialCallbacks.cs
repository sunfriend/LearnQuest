...
namespace Unity.Tutorials
{
    ...
    public class TutorialCallbacks : ScriptableObject
    {
        ...
        public void SelectSpawnedGameObject(FutureObjectReference futureObjectReference)
        {
            ...
            var sceneObjRef = futureObjectReference.SceneObjectReference as dynamic;
            if (sceneObjRef == null) return;
            SelectGameObject(sceneObjRef.ReferencedObjectAsGameObject);
        }
    ...
    public class FutureObjectReference
    {
        public object SceneObjectReference { get; internal set; }
    }
}